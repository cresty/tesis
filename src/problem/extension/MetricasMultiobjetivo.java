...
// % de soluciones q no son miembros del frente de pareto verdadero
	public double TasaError(List<State> solutionsFPcurrent, List<State> solutionsFPtrue) throws IOException{
		float tasaError = 0;
...
// % Indica  qué  tan  lejos  están  los  elementos  del frente  de  Pareto  actual  respecto  al  frente  de  Pareto  verdadero	
	public double DistanciaGeneracional(List<State> solutionsFPcurrent, List<State> solutionsFPtrue) throws  IOException{
		float min = 1000;
		float distancia = 0;
	...
	public double Dispersion(ArrayList<State> solutions) throws  IOException{
